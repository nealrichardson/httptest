structure(list(url = "http://httpbin.org/response-headers?Location=http%3A%2F%2Fhttpbin.org%2Fstatus%2F201", 
    ...
    date = structure(1519431730, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = structure(c(0, 3.1e-05, 3.3e-05,
    7.6e-05, 0.091662, 0.091723), .Names = c("redirect", "namelookup",
