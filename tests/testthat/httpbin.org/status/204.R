structure(list(url = "http://httpbin.org/status/204", status_code = 204L,
    headers = structure(list(`content-length` = "0", connection = "keep-alive",
        ...
        `x-processed-time` = "0", via = "1.1 vegur"), .Names = c("content-length",
    ...
    "via"), class = c("insensitive", "list")), all_headers = list(
    ...
    content = charToRaw(""), date = structure(1519431731, class = c("POSIXct",
    "POSIXt"), tzone = "GMT"), times = structure(c(0, 4.5e-05,
    4.8e-05, 0.000105, 0.100235, 0.100262), .Names = c("redirect",
