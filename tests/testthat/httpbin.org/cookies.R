structure(list(url = "http://httpbin.org/cookies", status_code = 200L,
    ...
    content = charToRaw("{\n  \"cookies\": {\n    \"token\": \"12345\"\n  }\n}\n"),
    date = structure(1505363690, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"),
    times = c(redirect = 0, namelookup = 0.123097, connect = 0.34047,
